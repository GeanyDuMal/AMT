...
class ProductFixture extends Fixture implements DependentFixtureInterface
{
    public function load(ObjectManager $manager): void
    {
        ...
        $productTypeBoisson = $productTypeRepository->findOneBy(["name" => "Boisson"]);
        $productTypeSnack = $productTypeRepository->findOneBy(["name" => "Snack"]);
        ...
        $product = new Product();
        $product->setName("Capri Sun MultiVitamine")
                ->setProductType($productTypeBoisson)
                ->setQuantityStock(10)
        ...
        $product = new Product();
        $product->setName("Capri Sun Tropical")
                ->setProductType($productTypeBoisson)
                ->setQuantityStock(10)
